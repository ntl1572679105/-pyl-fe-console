<template>
  ...
  >
    <div>
      <div style="margin-bottom: 20px">共{{propData.total}}条数据，其中{{propData.success}}条数据导入成功，{{propData.error}}条数据导入失败</div>
      <div>
        导入失败数据:
        <a-button style="margin-left: 20px" @click="downFile">
          下载表格
        </a-button>
      </div>
    </div>
